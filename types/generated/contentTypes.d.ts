...
export interface ApiDoctorDoctor extends Schema.CollectionType {
  ...
  attributes: {
    prescriptions: Attribute.String;
    patient_history: Attribute.String;
    medication_alerts: Attribute.String;
    appointment_information: Attribute.String;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      'api::doctor.doctor',
...
export interface ApiMedicalHistoryMedicalHistory extends Schema.CollectionType {
  ...
  attributes: {
    exams: Attribute.String;
    surgeries: Attribute.String;
    xrays: Attribute.String;
    medication_alerts: Attribute.String;
    patient_id: Attribute.UID;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
...
export interface ApiPatientPatient extends Schema.CollectionType {
  ...
  attributes: {
    ...
    medical_history: Attribute.String;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      'api::patient.patient',
...
export interface ApiPharmacyPharmacy extends Schema.CollectionType {
  ...
  attributes: {
    patient_prescriptions: Attribute.String;
    medication_withdrawal: Attribute.String;
    medication_history: Attribute.String;
    medication_reports: Attribute.String;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
...
export interface ApiPrescriptionPrescription extends Schema.CollectionType {
  ...
  attributes: {
    patient: Attribute.String;
    doctor: Attribute.String;
    prescribed_medications: Attribute.String;
